...
const List = () => {
    ...
    useEffect(() => {
        const fetchItems = async () => {
            try {
                const {data} = await axios.get('https://garnet-tsunamic-blotchily.ngrok-free.dev/api/items');
                setItems(data);
            } 
            catch (err) {
    ...
    const handleDelete = async (itemId) => {
        ...
        try {
            await axios.delete(`https://garnet-tsunamic-blotchily.ngrok-free.dev/api/items/${itemId}`);
