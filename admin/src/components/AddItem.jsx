    ...
    const handleSubmit = async e => {
        ...
        try {
            ...
            const res = await axios.post(
                'https://garnet-tsunamic-blotchily.ngrok-free.dev/api/items',
                payload,
            ...
            console.error('Gagal Upload Item:', err.response || err.message)
        }
    }
        ...
        <div className={styles.formWrapper}>
            <div className=' max-w-4xl mx-auto'>
                <div className={styles.formCard}>
                    <h2 className={styles.formTitle}>Tambah Item baru</h2>
                                ...
                                <div>
                                    ...
                                    <select name='category'
                                        ...
                                        required>
                                            ...
                                            {categories.map(c => (
                                                <option key={c} value={c} className=' bg-[#2a2b2b]'>
                                                    {c}
                                                </option>
                                            ))}
                                        </select>
