...
import { FaPlay, FaSearch, FaDownload, FaTimes } from "react-icons/fa";
                ...
                <div className=' max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 relative z-10'>
                    ...
                    <div className=' flex-1 space-y-8 relative md:pr-8 lg:pr-19 text-center md:text-left'>
                        ...
                        max-w-xl opacity-90 mx-auto md:mx-0'>
                            Koki terbaik dan kurir pengantaran terbaik siap melayani Anda. Makanan panas dan lezat akan sampai ke tempat Anda dalam waktu 60 menit.
                        </p>
                        ...
                        <form onSubmit={handleSearch} className=' relative max-w-2xl mx-auto md:mx-0 group'>
                            ...
                            shadow-2xl hover:bg-amber-400/50 transition-all duration-300'>
                                ...
                                placeholder='Temukan hidangan favorit Anda berikutnya...'
