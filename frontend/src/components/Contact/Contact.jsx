...
const Contact = () => {
    ...
    const handleSubmit = (e) => {
        ...
        const message = `
            ...
            // WHATSAPP NOMOR 
            const whatsappNumber = '+6285183324615'
            ...
            <div className=' max-w-7xl mx-auto relative z-10 '>
                ...
                <div className=' grid grid-cols-1 md:grid-cols-2 gap-8'>
                    ...
                    <div className=' space-y-6'>
                        <div className=' relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl tranform transition-all
                    ...
                    border-amber-500/30 hover:border-amber-500/50 transform-border duration-300'>
                        ...
                        <form onSubmit={handleSubmit} className=' space-y-6 relative z-10'>
                            ...
                            hover:to-orange-700 text-white font-semibold py-3 ppx6
