            ...
            <div className=' max-w-7xl mx-auto'>
                <div className=' text-center mb-14'>
                    ...
                    to-red-500 bg-clip-text text-transparent font-[Playfair_Display] italic'>
                        Promo <span className=' text-stroke-gold'>Spesial</span> Hari ini
                    </h1>
                    <p className=' text-lg text-gray-300 max-w-3xl mx-auto tracking-wide leading-relaxed'>
                        Nikmati keistimewaan dengan mahakarya kuliner kami yang dibuat dengan sempurna.
                    </p>
                </div>
                                ...
                                <div className=' relative h-72 overflow-hidden'>
                                    ...
                                    bg-black/40 backdrop-blur-sm px-4 py-2 rounded-full' >
                                        <span className=' flex items-center gap-2 text-amber-400 '>
                                            <FaStar className=' text-xl drop-shadow-[0_2px_2px_rgba(0,0,0.8)]' />
                                    ...
                                    <div className=' flex items-center justify-between gap-4'>
                                        ...
                                        {qty > 0 ? (
                                            <div className=' flex items-center gap-3'>
                                                ...
                                                }} className=' w-8 h-8 rounded-full bg-amber-800/40 flex items-center
