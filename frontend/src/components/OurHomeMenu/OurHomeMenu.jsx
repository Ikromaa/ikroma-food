...
const OurHomeMenu = () => {
    ...
    const {cartItems, addToCart, removeCart, updateQuantity} = useCart();
    const [menuData, setMenuData] = useState({});

    useEffect(() => {
        axios.get('https://garnet-tsunamic-blotchily.ngrok-free.dev/api/items')
        .then(res => {
        ...
        px-4 sm:px-6 lg:px-8'>
            <div className=' max-w-7xl mx-auto'>
                ...
                bg-gradient-to-r from-amber-200 via-amber-300 to-amber-200'>
                    ...
                    <span className=' block text-xl sm:text-2xl md:text-3xl font-cinze1 mt-4 text-amber-100/80'>
                                        ...
                                        <div className=' flex items-center gap-2'>
                                            {qty > 0 ? (
                                                ...
                                                justify-center hover:bg-amber-800/50 transition-colors'
                                                    onClick={() => qty > 1 ? updateQuantity(cartEntry._id, qty - 1) : removeCart(cartEntry._id)}>
                ...
                <div className=' flex justify-center mt-16'>
                    ...
                    sm:px-10 py-3 rounded-full font-cinzel uppercase tracking-widest transition-all duratio-300
